...
class Help(private val bot: Bot): Command(bot.jda, Access.PUBLIC, "help", arrayOf("h"),  null, null) {
    ...
    override fun run(event: GuildMessageReceivedEvent, args: List<String>) {
        ...
        embed.setDescription("Avant chaque commande, il faut utiliser le prefix `${bot.prefix}`")
